            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<%=request.getContextPath()%>/index.jsp">Account</a></li>
                        <li><a href="<%=request.getContextPath()%>/vacxin.jsp">Vắc xin</a></li>
                        <li><a href="<%=request.getContextPath()%>/lichsutiemphong.jsp">Lịch sử</a></li>
                        <li><a href="<%=request.getContextPath()%>/thongke.jsp">Thống kê</a></li>
